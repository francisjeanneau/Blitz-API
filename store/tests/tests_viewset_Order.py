...
SAMPLE_PROFILE_RESPONSE = {
    'id': 'd351cecf-0478-4602-8995-eef6ad82cc3a',
    'status': 'ACTIVE',
    'merchantCustomerId': '5181',
    'locale': 'en_US',
    'firstName': 'Heather',
    'lastName': 'Brewer',
    'paymentToken': 'PyetqMhrQciAB2D',
    'email': 'john8@blitz.com',
    'addresses': [],
    'cards': [{
        'status': 'ACTIVE',
        'id': '4a551b67-8527-4164-bcf8-d11cf3b9bbf3',
        'cardBin': '411111',
        'lastDigits': '1111',
        'cardExpiry': {
            'year': 2041, 'month': 2
        ...
        'cardType': 'VI',
        'paymentToken': 'CKZRAqTM8BXdaDr',
        'defaultCardIndicator': True,
        'singleUseToken': 'SCHYmjnSwDytPOGk'
    }]
}
